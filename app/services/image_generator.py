...
def extract_scene_prompts(
    ...
    prompt = (
        ...
        f"  被写体は物語の内容に合わせて多様に選ぶこと。以下は発想の例であり、毎回同じ方向に寄せない:\n"
        f"   - 白髪の老人が神棚の前に正座し後頭部だけがこちらを向いている\n"
        f"   - 赤い着物の少女が無人の廊下の奥から無表情で立ちすくむ\n"
        f"   - 瞳孔の開いた黒猫が床の間から微動だにせずこちらを見つめる\n"
        f"   - 受話器が外れた黒電話が誰もいない部屋で揺れ動く\n"
        f"   - 黒髪を垂らした女が襖の隙間からこちらを覗く\n"
        f"   - 誰もいない真夜中の学校の教室の隅に長く伸びる影\n"
        f"   - 作業着姿の中年男性が山中の祠の前で身動ぎせず立っている\n"
